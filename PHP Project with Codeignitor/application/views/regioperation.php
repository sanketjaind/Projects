        ...
        <div id="wrapper">
			...
			<div id="main">
           		<div style="margin-top:170px">
					<div class = "addcenter">
						<h1 align="center" style="color:black ; margin-bottom:50px"> Registration Operation </h1>
							</div>
							<div class="register">
								<form action="http://localhost/bits/index.php/hom/registart" method="post">
									<div class="register-switch">
							          <input type="radio" name="start" value="1" id="i" class="register-switch-input" checked>
								      <label for="i" class="register-switch-label">Start</label>
								      <input type="radio" name="start" value="0" id="f" class="register-switch-input">
								      <label for="f" class="register-switch-label">End</label>
								    </div>
									<button type="submit" class="register-button">Submit</button>
								</form>
							
							
								<form action="http://localhost/bits/index.php/hom/registop" method="post">
									<div class="register-switch" style="margin-top:30px">
							          <input type="radio" name="stop" value="1" id="i1" class="register-switch-input" checked>
								      <label for="i1" class="register-switch-label">Stop</label>
								      <input type="radio" name="stop" value="0" id="f1" class="register-switch-input">
								      <label for="f1" class="register-switch-label">Not Stop</label>
								    </div>
									<button type="submit" class="register-button">Submit</button>
								</form>
