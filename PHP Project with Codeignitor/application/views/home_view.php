                        ...
                        <div class="headercontent">
                            <div class="section-container">
                                ...
                                <div  style="margin-top:170px">
									<div >
										<h1 align="center" style="color:#000000"> ADD CENTER </h1>
									</div> 
									<form action="http://localhost/bits/index.php/hom/addcenter" method="post">
										<div class="register">
											<input type="text" name="city" class="register-input" placeholder="City" maxlength="15" required>
											<input type="text" name="place" class="register-input" placeholder="Place/location" maxlength="10" required>
											<input type="number" name="roomsize" class="register-input" placeholder="number of room" maxlength="10" required>
											<input type="number" name="maxsize" class="register-input" placeholder="max size" maxlength="10" required>
											<input type="submit" value="Add center" class="register-button">
										</div>
									</form>
									<h6 align="center" >
									<?php 
