                ...
                <div id="main-nav">
                    <div id="nav-container">
                        ...
                        <ul id="navigation">
                            ...
                            <li>
                              <a href="http://localhost/bits/index.php/hom/exam_detail">
                                <div class="icon icon-book"></div>
                                <div class="text">Exam Date</div>
                              </a>
                            </li> 
                            ...
                            <li>
                              <a href="http://localhost/bits/index.php/hom/student_logout">
                                <div class="icon icon-time"></div>
                        ...
                        <div class="headercontent">
                            <div class="section-container">
                                ...
                                <div  style="margin-top:30px">
									<div >
										<h1 align="center" style="color:#000000"> Student Information </h1>
									</div> 
									

									<!--<h6 style="color:blue" align="center" >-->
										
									<?php 
									    echo '<div style="margin-left:330px" >';
									    echo '<table class="CSSTableGenerator" style="width:50%">';
									    echo '<tr>';
										    echo '<td> Name of field</td>';
											echo '<td> value </td>';
										echo '</tr>';

									    echo '<tr>';
										    echo '<td> Name </td>';
											echo '<td>'.$first." ".$last."</br>".'</td>';
										echo '</tr>';
										
										echo '<tr>';
											echo '<td> data of birth </td>';
											echo '<td>'.$dob."</br>".'</td>';
										echo '</tr>';
										...
										echo '<tr>';
											echo '<td> school </td>';
											echo '<td>'.$school."</br>".'</td>';
										echo '</tr>';
										
										echo '<tr>';
											echo '<td> Percent </td>';
											echo '<td>'.$percent."</br>".'</td>';
										echo '</tr>';
										
										echo '<tr>';
											echo '<td> Passing year </td>';
											echo '<td>'.$passingyear."</br>".'</td>';
										echo '</tr>';
										
										echo '<tr>';
											echo '<td> Preferences 1 </td>';
											echo '<td>'.$p1."</br>".'</td>';
										echo '</tr>';
										
										echo '<tr>';
											echo '<td> Preferences 2 </td>';
											echo '<td>'.$p2."</br>".'</td>';
										echo '</tr>';

										echo '<tr>';
											echo '<td> Preferences 3 </td>';
											echo '<td>'.$p3."</br>".'</td>';
										echo '</tr>';
